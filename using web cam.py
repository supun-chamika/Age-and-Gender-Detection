...
def predict_age_and_gender():
    ...
    while True:
        ...
        for i, (start_x, start_y, end_x, end_y) in enumerate(faces):
            ...
            # predict age
            age_prediction = get_age_predictions(face_img)
            # predict gender
            gender_prediction = get_gender_predictions(face_img)
            i = gender_prediction[0].argmax()
            gender = GENDER_LIST[i]
            gender_confidence_score = gender_prediction[0][i]
            i = age_prediction[0].argmax()
            age = AGE_INTERVALS[i]
            age_confidence_score = age_prediction[0][i]
            # Draw the box
